                   ...
                   <Link href="/">
                    ...
                    <div className="flex gap-5 ">
                        <div>
                            ...
                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2.581 0a1.5 1.5 0 105.09-2.31M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
